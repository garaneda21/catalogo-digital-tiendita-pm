                ...
                <div class="w-[350px] bg-gray-50 border rounded-xl p-4 flex-shrink-0">
                    <div class="flex items-start space-x-4 mb-4">
                        ...
                        <img class="w-16 h-16 object-cover rounded-md shrink-0"
                            src="{{ $top_producto->producto->imagen_url ? asset('storage/' . $top_producto->producto->imagen_url) : '/images/placeholder-product.jpg' }}"
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="/admin/productos/{{ $top_producto->producto->id }}"
                            class="text-sm text-melocoton hover:underline">Ver detalles</a>
                    </div>
                </div>
            @endforeach
        </div>
